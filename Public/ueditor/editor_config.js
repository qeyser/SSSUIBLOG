...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","insertunorderedlist","insertorderedlist","unlink","link","searchreplace","preview","separate","pagebreak","insertimage","music","emotion","insertvideo","attachment","insertframe","horizontal","anchor","webapp","blockquote","highlightcode","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifycenter","justifyleft","justifyright","justifyjustify","removeformat","formatmatch","fontfamily","fontsize","inserttable","gmap","fullscreen","undo","redo","selectall","print","cleardoc","help","date","time","wordimage","map","spechars","background","template","paragraph","rowspacingbottom","rowspacingtop","lineheight","imagenone","imageleft","imageright","imagecenter","autotypeset","pasteplain","customstyle","indent","directionalityrtl","directionalityltr","tolowercase","touppercase","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
